...
public class ViewNotificationTeam extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.view_team_invite, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        accept = (Button) getView().findViewById(R.id.acceptB);
        reject = (Button) getView().findViewById(R.id.rejectB);
        ...
        accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                response = true;
                new HttpAsyncTask2().execute(Utilites.URL_AcceptInvitation);
            }
        });
    ...
    private class HttpAsyncTask2 extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            try {
                ...
                jsonObject.put("accept", response);
        ...
        protected void onPostExecute(String result) {
            ...
            fragmentTransaction.replace(R.id.team_invite_id, fragment);
